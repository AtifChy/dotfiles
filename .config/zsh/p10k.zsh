# Generated by Powerlevel10k configuration wizard on 2024-07-27 at 15:53 +06.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( VCS_STATUS_COMMITS_AHEAD || VCS_STATUS_COMMITS_BEHIND )); then
      ...
      # ⇣42 if behind the remote; no leading space if also behind the remote: ⇡42⇣42.
    ...
    # ⇠42 if behind the push remote; no leading space if also behind: ⇢42⇠42.
